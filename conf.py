...
BLOG_AUTHOR = "Rene Wang"  # (translatable)
BLOG_TITLE = "ReneWangritte"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://renewang.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
BASE_URL = "http://renewang.github.io/"
BLOG_EMAIL = "renewangtw@gmail.com"
BLOG_DESCRIPTION = "Travel, Photos, Gourmet, Living And Beyond ..."  # (translatable)
...
import re
# wordpress compatible setting 
#TEASER_REGEXP = re.compile('<!--\s*(more|TEASER_END)(:(.+))?\s*-->', re.IGNORECASE)
TEASER_REGEXP = re.compile('<a name="(more)">(.*)?</a>', re.IGNORECASE) 
...
# is in the manual.
COMMENT_SYSTEM_ID = "renewangritte"
...
GLOBAL_CONTEXT = {
        'TWITTER_URL': 'https://twitter.com/renewangtw',
        'GITHUB_URL': 'https://github.com/renewang',
        'BANNER_URL': '/assets/img/silk-road.jpg',
        'INDEX_BANNER': '/assets/img/cropped-07f93-dsc00813.jpg',
        }
